## This script is used to decide number of responses need to collect for UMAP 0.1 and 0.6 combinations.
...
## Run only once
write_rds(prob_tb, here::here("data/vis-exp/umap_0.1_0.6_three_clust_pwr_results.rds"))
