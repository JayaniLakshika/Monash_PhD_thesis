## Model only with TriMAP 0.6 and 1 distance factors
...
p1 <- 0.669 ## from collected data
p2_seq <- p1 + seq(0.01, 0.3, 0.01) ## from collected data (0.689)
ntrials <- 1000
n_seq <- seq(5, 100, 5)
...
## Run only once
write_rds(prob_tb, "data/trimap_0.6_1_three_clust_sample_size_determination.rds")
