## Model only with tSNE 0.1 and 0.6 distance factors
...
p1 <- 0.407 ## from collected data
p2_seq <- p1 + seq(0.01, 0.4, 0.01) ## from collected data (0.467)
ntrials <- 1000
n_seq <- seq(5, 100, 5)
...
## Run only once
write_rds(prob_tb, "data/tsne_0.1_0.6_three_clust_sample_size_determination.rds")
