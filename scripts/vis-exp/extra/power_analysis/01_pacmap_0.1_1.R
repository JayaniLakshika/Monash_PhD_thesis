## Model only with PaCMAP 0.1 and 1 distance factors
...
p1 <- 0.290 ## from collected data
#p2_seq <- 0.589 ## from collected data
p2_seq <- p1 + seq(0.01, 0.4, 0.01) ## from collected data (0.60)
ntrials <- 1000
n_seq <- seq(5, 100, 5)
...
## Run only once
write_rds(prob_tb, "data/pacmap_0.1_1_three_clust_sample_size_determination.rds")
