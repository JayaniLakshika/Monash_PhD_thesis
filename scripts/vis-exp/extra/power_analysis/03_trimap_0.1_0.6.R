## Model only with TriMAP 0.1 and 0.6 distance factors
...
p1 <- 0.61 ## from collected data
p2_seq <- p1 + seq(0.01, 0.3, 0.01) ## from collected data (0.66)
ntrials <- 1000
n_seq <- seq(5, 100, 5)
...
## Run only once
write_rds(prob_tb, "data/trimap_0.1_0.6_three_clust_sample_size_determination.rds")
