## Model only with PHATE 0.1 and 1 distance factors
...
p2_seq <- p1 - seq(0.01, 0.3, 0.01) ## from collected data (0.290)
ntrials <- 1000
n_seq <- seq(5, 100, 5)
...
## Run only once
write_rds(prob_tb, "data/phate_0.1_1_three_clust_sample_size_determination.rds")
