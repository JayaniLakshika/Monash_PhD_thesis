## Model only with UMAP 0.1 and 1 distance factors
...
p1 <- 0.41 ## from collected data
#p2_seq <- 0.82
p2_seq <- p1 + seq(0.01, 0.6, 0.1) ## from collected data (0.82)
actual_p2 <- 0.82 ## from collected data
ntrials <- 1000
n_seq <- seq(5, 75, 1)
...
## Run only once
write_rds(prob_tb, "data/umap_0.1_1_four_clust_sample_size_determination.rds")
