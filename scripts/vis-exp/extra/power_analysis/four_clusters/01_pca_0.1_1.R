## Model only with PCA 0.1 and 1 distance factors
...
p1 <- 0.88 ## from collected data
p2_seq <- p1 + seq(0.03, 0.12, 0.01) ## from collected data (1)
#p2_seq <- 1 ## from collected data
actual_p2 <- 1 ## from collected data
ntrials <- 1000
n_seq <- seq(5, 200, 5)
...
## Run only once
write_rds(prob_tb, "data/pca_0.1_1_four_clust_sample_size_determination.rds")
