...
::: {.cell}
::: {.cell-output-display}
![UMAP representation of a human PBMC CITE-seq dataset [@hao2021] generated using n_neighbors = 30 and min_dist = 0.3. The layout suggests the presence of multiple clusters with different shapes, including compact, well-separated groups as well as elongated and partially overlapping structures. *Is this the most reasonable representation of the structure(s) present in the PBMC CITE-seq data?*](01-chap1_files/figure-html/fig-NLDR-variety-intro-1.png){#fig-NLDR-variety-intro fig-pos='H' width=50%}
:::
:::
