...
## Supporting R and Python packages

<!--need to update at the end of writing-->
In addition, a number of R and Python packages were essential in the development of this work, including `tidyverse` [@hadley2019], `ggbeeswarm` [@erik2023], `ggrepel` [@kamil2024], `GGally` [@barret2025], `colorspace` [@achim2020], `scales` [@hadley2025], `patchwork` [@thomas2024], `plotly` [@chapman2020], `crosstalk` [@joe2025], `htmltools` [@joe2024], `quollr` [@jayani2025a], `cardinalR` [@jayani2025b], `detourr` [@casper2025], `geozoo` [@barret2016], `knitr` [@yihui2015], `kableExtra` [@hao2024], `lme4` [@douglas2015], `broom.mixed` [@ben2024], `emmeans` [@russell2025], `mclust` [@scrucca2023], `fpc` [@christian2024], `binom` [@sundar2022], `conflicted` [@hadley2023], `ggforce` [@thomas2025], `here` [@kirill2025], `grid` [@core2025], `gridExtra` [@baptiste2017],`png` [@simon2022], `gtools` [@gregory2023], `stats` [@core2025], `mvtnorm` [@alan2009], `MASS` [@venables2002], `scikit-learn` [@pedregosa2011], `Rtsne` [@jesse2015], `uwot` [@james2025b], `phateR` [@moon2019], `pacmap` [@wang2021], `trimap` [@amid2022], and `reticulate` [@kevin2025].
