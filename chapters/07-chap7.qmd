...
hex_grid_pbmc_int <- plot_ly() |>
  # Background points (pbmc_umap_scaled)
  add_trace(
    data = pbmc_umap_scaled,
    x = ~emb1,
    y = ~emb2,
    type = 'scatter',
    mode = 'markers',
    marker = list(color = '#66B2CC', size = 5, opacity = 0.03),
    hoverinfo = 'none',
    showlegend = FALSE
  ) |>
...
pbmc_umap_model_vis <- langevitour::langevitour(df_exe[1:(length(df_exe)-1)],
  ...
  htmltools::div(
    ...
    htmltools::div(
      style = "
        ...
        padding: 0;
      ",
      htmltools::div(style = "margin: 0; padding: 0;", hex_grid_pbmc_int),
      htmltools::div(style = "margin: 0; margin-top: 13px; padding: 0;", pbmc_umap_model_vis)
    )
  ),
  device = "xs"
)
