...
clust_data <- gen_multicluster(
  ...
  loc = matrix(c(
    ...
    5, 9, 6, 8,
    3, 4, 10, 7
  ) * 0.3, nrow = 6, byrow = TRUE),
  scale = c(0.3, 0.5, 0.8, 1, 1, 1),
  shape = c("gaussian", "gaussian", "gaussian", "quadratic", "sphericalspiral", "conicspiral"),
  is_bkg = FALSE
)

## Add noise dimensions
noise_df <- gen_noisedims(n = sum(c(500, 700, 700, 500, 700, 700)), 
              p = 6, m = rep(0.9, 6), 
              s = rep(0.01, 6))
names(noise_df) <- c("x", 5:10)
