...
Using the `cardinalR` package, data with these different cluster shapes and background noise can be generated (`r knitr::asis_output(if (knitr::is_html_output()) { "@fig-dt-tourr-sim"} else { "@fig-dt-prj-sim"})`).
