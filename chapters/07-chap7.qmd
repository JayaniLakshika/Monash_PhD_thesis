...
hex_grid_pbmc <- ggplot(
  ...
  geom_point(data = df_bin_centroids_pbmc, 
             aes(x = c_x, y = c_y), 
             size = 0.5, color = "#FF7755")

hex_grid_pbmc_int <- ggplotly(hex_grid_pbmc, 
                                width = "350", 
                                height = "380", 
                                tooltip = "none") |>
  config(
