...
#| fig-cap: "Three $2\\text{-}D$ projections of the $10\\text{-}D$ PBMC CITE-seq data produced using a tour. The dataset shows six well-separated yet closely positioned clusters, including three with nonlinear geometric structures and three approximately Gaussian clusters, along with a small amount of background noise."
