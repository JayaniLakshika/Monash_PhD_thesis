...
::: {.cell layout-align="center"}
::: {.cell-output-display}
![Examining the correct proportion accross data sets used in the experiment and subjects.](05-chap5_files/figure-html/fig-var-sum-1.png){#fig-var-sum fig-align='center' width=100%}
:::
:::
