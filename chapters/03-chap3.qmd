...
```{r overviewhtml, eval=knitr::is_html_output(), fig.pos='H'}
...
```{r algo-step-html, eval=knitr::is_html_output(), fig.pos='H', fig.cap="Key steps for constructing the model on the UMAP layout: (a) hexagon bins, (b) bin centroids, (c) triangulated centroids, and (d) lifting the model into high dimensions. The `Scurve` data is shown."}
...
knitr::include_graphics(c(here::here("figures/quollr/model_link_proj1_detourr.png"),
                          here::here("figures/quollr/model_link_proj2_detourr.png")))
```
...
knitr::include_graphics(c(here::here("figures/quollr/model_link_error_proj1_detourr.png"),
                          here::here("figures/quollr/model_link_error_proj2_detourr.png")))
```
