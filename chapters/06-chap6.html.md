...
-   **Seeing the Model in High Dimensions:** Some participants did not understand how the $2\text{-}D$ layout relates to the high-dimensional model. To address this, we added a $2\text{-}D$ wireframe step, which allows users to see the underlying structure before lifting it into high dimensions.shiny
