...
::: {.cell layout-align="center"}
::: {.cell-output-display}
![Key steps for constructing the model on the tSNE layout ($k=2$) of 2NC7: (a) data, (b) hexagon bins, (c) bin centroids, and (d) triangulated centroids. The 2NC7 data is shown.](02-chap2_files/figure-html/fig-NLDR-two-curvy-1.png){#fig-NLDR-two-curvy fig-align='center' width=100%}
:::
:::
