...
nldr1_three_clust_13_tsne <- get_embeddings(dt_structutre = "three_clust_07") |>
  filter(scale_factor == c(0.1, 1.1)) |>
  filter(method %in% c("tsne")) |>
  mutate(scale_factor = recode(scale_factor,
                               `0.1` = "S",
...
nldr1_three_clust_13_umap <- get_embeddings(dt_structutre = "three_clust_07") |>
  filter(scale_factor == c(0.1, 1.1)) |>
  filter(method %in% c("umap")) |>
  mutate(scale_factor = recode(scale_factor,
                               `0.1` = "S",
...
(three_clust13_proj1/ three_clust13_proj1_1) | (three_clust13_proj2_1/ three_clust13_proj2) | nld_plt1_three_clust_13_tsne | nld_plt1_three_clust_13_umap
```
