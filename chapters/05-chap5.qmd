...
#| fig-width: 12
#| label: fig-var-sum
#| fig-cap: "Correct identification proportions by (a) data structure and (b) participant. The plot a shows aggregated proportions with $95\\%$ Wilson binomial confidence intervals, illustrating differences in identification difficulty across three-cluster structures. The plot b displays participant-level proportions and highlight between-subject variability."
