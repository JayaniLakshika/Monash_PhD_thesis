...
source("scripts/cardinalR/additional_functions.R")
```
...
knitr::include_graphics("figures/cardinalR/cardinalR_workflow.png")
```
...
tsne_data <- read_rds("data/cardinalR/five_clusts/five_clusts_tsne_perplexity_30.rds") 
...
umap_data <- read_rds("data/cardinalR/five_clusts/five_clusts_umap_n-neigbors_15_min-dist_0.1.rds") 
...
phate_data <- read_rds("data/cardinalR/five_clusts/five_clusts_phate_knn_5.rds") 
...
trimap_data <- read_rds("data/cardinalR/five_clusts/five_clusts_trimap_n-inliers_12_n-outliers_4_n-random_3.rds") 
...
pacmap_data <- read_rds("data/cardinalR/five_clusts/five_clusts_pacmap_n-neighbors_10_init_random_MN-ratio_0.5_FP-ratio_2.rds") 
...
pca_data <- read_rds("data/cardinalR/five_clusts/five_clusts_pca.rds") 
...
```{r}
error_five_clust <- read_rds("data/cardinalR/five_clusts/five_clusts_rmse.rds")
