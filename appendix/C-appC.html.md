...
::: {.cell layout-align="center"}
::: {.cell-output-display}
![Allocation of method and distance scale factor to the first 9 participants for the SAME attempts only. Each participant has experienced all factor combinations with randomly assigned data structures.](C-appC_files/figure-html/fig-validate-exp-design-ds-1.png){#fig-validate-exp-design-ds fig-align='center' fig-pos='H' width=100%}
:::
:::
